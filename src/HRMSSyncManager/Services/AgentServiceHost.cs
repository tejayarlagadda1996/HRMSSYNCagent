...
namespace HRMSSyncManager.Services;
...
public static class AgentServiceHost
{
    public static void Run(string[] args)
    {
        ...
        try
        {
            ...
            Log.Information("HRMSAgent background service starting");
        ...
        {
            Log.Fatal(ex, "HRMSAgent background service terminated unexpectedly");
            throw;
        }
        finally
        {
            Log.Information("HRMSAgent background service shutting down");
            Log.CloseAndFlush();
        }
    }
}
